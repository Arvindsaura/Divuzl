    ...
    <section className="bg-[#0027cc] text-white py-20 w-full dm-sans-heading">
      <div className="mx-[12.5vw] w-[75vw] relative">
        ...
        <div className="mb-8">
          ...
          <h2 ref={headingRef} className="text-white text-5xl md:text-6xlfont-semibold">
        ...
        >
          <div className="p-8 h-[380px] rounded-xl bg-[#001f99] bg-opacity-90 shadow-lg flex flex-col justify-start overflow-hidden relative">
            ...
            <div className="absolute bottom-6 left-6 flex items-center gap-4">
              <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center text-[#0027cc] dm-sans-body">
                {testimonials[active].name[0]}
              </div>
              <div>
                <p className="font-bold text-white dm-sans-body">{testimonials[active].name}</p>
                <p className="text-sm text-white/70 dm-sans-body">{testimonials[active].title}</p>
              </div>
            </div>
