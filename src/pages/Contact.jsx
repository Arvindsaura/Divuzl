  ...
  return (
    <div className="w-full min-h-screen bg-white text-neutral-900 py-16 md:py-24 px-6 md:px-[10vw] space-y-24 md:space-y-32 dm-sans-body">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-24">
        ...
        <div className="space-y-14">
          ...
          {state.succeeded ? (
            ...
            <form
              ...
              className="space-y-6 text-sm montserrat-regular"
            >
        ...
        {/* Right Section — Info */}
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-12 text-sm lg:pl-4">
          {/* Primary Mail */}
          <div className="sm:col-span-2">
            <p className="text-neutral-500 uppercase text-xs tracking-widest mb-1">
              Mail Us
            </p>
          ...
          {/* Other Emails */}
          <div className="sm:col-span-2 space-y-2 text-[15px]">
            {[
            ...
            <div className="flex flex-row flex-wrap gap-4">
              {socials.map((s, i) => (
                <a
                  ...
                  className="flex items-center justify-center w-10 h-10 rounded-full border border-neutral-300 hover:border-[#0047FF] hover:text-[#0047FF] transition text-lg"
                >
                  {s.icon}
                </a>
              ))}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 text-center text-sm w-full max-w-5xl mx-auto pt-12 border-t border-neutral-200 dm-sans-body">
        {[
          {
            title: "Always Custom",
            desc: "No templates. No fluff. Just thoughtful design, built for you.",
          },
          {
            title: "Tech-first",
            desc: "We blend creativity with performance — powered by code.",
          },
          {
            title: "Real People",
            desc: "No agencies, no pipelines. You talk directly to the makers.",
          },
        ].map((item, i) => (
      ...
      <div className="mt-20 md:mt-24 text-center px-6 py-12 md:py-14 rounded-3xl">
        <h2 className="text-xl md:text-2xl font-semibold mb-3">
          Let’s create your next breakthrough.
        </h2>
