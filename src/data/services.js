...
export const services = [
  ...
  },
  {
    ...
    whatWeOffer: [
      ...
      "Brand collaborations & co-marketing initiatives ",
    ...
    process: [
      ...
      "Partnership Launch & Tracking"
    ]
  },

  // Marketing & Branding Pillar
  {
    id: 2,
...
// Group services into pillars
export const servicePillars = [
  {
    name: "Business & Strategy",
    slug: "business-strategy",
    description: "Build a strong foundation and plan your growth. We handle the legal, financial, and strategic groundwork so you can focus on building your business.",
    services: services.filter((s) => s.category === "Business & Strategy"),
  },
  {
    name: "Marketing & Branding",
    slug: "marketing-branding",
    description: "Make your brand unforgettable. We create compelling visuals, tell your story, and drive customer engagement to help you stand out in the market.",
    services: services.filter((s) => s.category === "Marketing & Branding"),
  },
  {
    name: "Technology & Development",
    slug: "technology-development",
    description: "Power your business with technology. We build high-performing websites and apps, and integrate systems to make your operations faster and smarter.",
    services: services.filter((s) => s.category === "Technology & Development"),
  },
  {
    name: "Events & PR",
    slug: "events-pr",
    description: "Get noticed and build credibility. We manage impactful events and strategic media outreach to boost your brand's presence and authority.",
    services: services.filter((s) => s.category === "Events & PR"),
  },
];
